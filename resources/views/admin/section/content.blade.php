...
{{--                                    </div>--}}
{{--                                    <!-- /.direct-chat-info -->--}}
{{--                                    <img class="direct-chat-img" src="/manager/dist/img/user1-128x128.jpg" alt="message user image">--}}
{{--                                    <!-- /.direct-chat-img -->--}}
...
{{--                                    </div>--}}
{{--                                    <!-- /.direct-chat-info -->--}}
{{--                                    <img class="direct-chat-img" src="/manager/dist/img/user3-128x128.jpg" alt="message user image">--}}
{{--                                    <!-- /.direct-chat-img -->--}}
{{--                                    <div class="direct-chat-text">--}}
{{--                                        بهتره اینو باور کنی :)--}}
{{--                                    </div>--}}
...
{{--                                    <li>--}}
{{--                                        <a href="#">--}}
{{--                                            <img class="contacts-list-img" src="/manager/dist/img/user1-128x128.jpg">--}}
...
{{--                                    <li>--}}
{{--                                        <a href="#">--}}
{{--                                            <img class="contacts-list-img" src="/manager/dist/img/user7-128x128.jpg">--}}
...
{{--                                    <li>--}}
{{--                                        <a href="#">--}}
{{--                                            <img class="contacts-list-img" src="/manager/dist/img/user3-128x128.jpg">--}}
...
{{--                                    <li>--}}
{{--                                        <a href="#">--}}
{{--                                            <img class="contacts-list-img" src="/manager/dist/img/user5-128x128.jpg">--}}
...
{{--                                    <li>--}}
{{--                                        <a href="#">--}}
{{--                                            <img class="contacts-list-img" src="/manager/dist/img/user6-128x128.jpg">--}}
...
{{--                                    <li>--}}
{{--                                        <a href="#">--}}
{{--                                            <img class="contacts-list-img" src="/manager/dist/img/user8-128x128.jpg">--}}
