                            ...
                            <ul>
                                ...
                                <li>
                                    <h1 style="font-size: 14px">
                                        تسویه حساب هر هفته شنبه ساعت 12 انجام میشود
                                    </h1>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div>
                        <div id="topfilter" class="shade">
                            ...
                            <div class="left">
                                ...
                                <ul class="oredering">
                                    <li>
                                        <span onclick="window.location.href='{{route('teacher.wallet')}}'">همه</span>
                                    </li>
{{--                                    <li class="{{(request('type'))?'active':''}}" onclick="window.location.href='{{request()->fullUrlWithQuery(['type'=>'charge_wallet'])}}'"><span>شارژ کیف</span></li>--}}
{{--                                    <li ><span>برداشت</span></li>--}}
{{--                                    <li><span>درحال تسویه</span></li>--}}
                                </ul>
                            </div>
                        </div>
                    </div>
...
{{--                        <form action="{{route('teacher.charge.wallet',$user->id)}}" class=" " method="post"  >--}}
                            @csrf
                            @method('post')
                        <div class="pay-form">
                            <div class="right">
                            ...
                            <div class="left">
                                ...
                                <div class="input-container fill">
                                    ...
                                    <label for="">(تومان)مبلغ را وارد کنید</label>
