...
{{--                        <li><a href="#"><i class="icon-bell"></i><span class="num">3</span></a></li>--}}
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div>
                            ...
                            <div class="input-container fill">
                                ...
                                <input type="text" name="title" value="{{$Article->title}}"  placeholder="‏عنوان مقاله را بنويسيد">
                        ...
                        <div>
                            ...
                            <div class="input-container1 fill1">
                                <div id="fileuploader" class="fl">
                                    ...
                                    <br>
                                    <br>
                                    <input type="file" id="featured-pic" accept="image/*" name="image">
                                    @error('image')<div class="eerror">{{ $message }}</div>@enderror
                                    <img style="border: 2px solid #0eb582;box-sizing: border-box; border-radius: 15px; " src="{{asset('src/article/images/').'/'.$Article->image}}" alt="">
   ...
   <div class="row">
                    <div class="col-lg-12">
                        <div>
                            <textarea name="article" id="mytextarea">{{$Article->article}}</textarea>
                            ...
                            <div class="add-tag">
                                ...
                                <div class="result">
                                    @if( $Article->tag)
                                        ...
                                        @endphp
                                    @foreach(  $tags as $ta)
                                        <span><input name="tag[]" hidden="" value="{{($ta)}}"> {{$ta}}<i class="icon-close"></i></span>
                                    @endforeach
                                        @endif
                                </div>
                            </div>
